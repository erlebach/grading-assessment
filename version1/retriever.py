...
class DualIndexRetriever:
    ...
    def format_evidence_for_grading(self, evidence_list: list[dict[str, Any]]) -> str:
...
if __name__ == "__main__":
    ...
    student_answer = (
        "Mutual information tells us how much knowing Y reduces uncertainty about X."
    )
    ...
    for i, result in enumerate(results, 1):
        print(f"  {i}. {result['source_id']} (rerank: {result['rerank_score']:.3f})")
    ...
    dup_results2 = [
        ...
        {
            "source_id": "s1",
            "text": "text1_different",
            "score": 0.7,
        },  # Different text, same source
